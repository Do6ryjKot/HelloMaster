...
namespace HelloWorker.Wpf.Commands.WorkplaceCommands.PopUp {
	...
	/// </summary>
	public class EditWorkplaceCommand : CommandBase {
		...
		public EditWorkplaceCommand(WorkplaceAddEditPopUpViewModel viewModel,
		...
		public override void Execute(object parameter) {
			...
			try {
				...
				_workplacesStore.Update(_viewModel.SetUp());
